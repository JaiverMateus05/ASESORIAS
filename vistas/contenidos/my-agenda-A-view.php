...
<div class="container-fluid">
    ...
    <li>
            <a  class="active" href="<?php echo SERVERURL; ?>my-agenda-A/"><i class="fa fa-calendar"></i> &nbsp; MIS ASESORIAS</a>
        </li>
        <li>
...
<div class="container-fluid">
    ...
    $ins_agenda_A = new agendaControlador();

    echo $ins_agenda_A->paginar_agenda_asesor_controlador($pagina[1],5,$_SESSION['id_sav'],"",$pagina[0]);
    ?>
</div>