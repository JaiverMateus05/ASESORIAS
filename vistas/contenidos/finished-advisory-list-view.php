...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fa fa-book"></i> &nbsp; ASESORIAS FINALIZADAS
    </h3>
</div>
<div class="container-fluid">
    ...
    <li>
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL; ?>finished-advisory-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; ASESORIAS FINALIZADAS</a>
        </li>
        <li>
...
<div class="container-fluid">
    ...
    echo $ins_histo->paginar_historial_finalizada_controlador($pagina[1],5,$_SESSION['id_sav'],"",$pagina[0]);
    ?>
</div>